...
class _LoginPageState extends State<LoginPage> {
  ...
  final List<Map<String, String>> regionsList = [
    ...
    {"id": "21", "name": "Bélier", "code": "21"},
    {"id": "22", "name": "Béré", "code": "22"},
    {"id": "23", "name": "Bounkani", "code": "23"},
    {"id": "24", "name": "Folon", "code": "24"},
    {"id": "04", "name": "Gbeke", "code": "04"},
    {"id": "25", "name": "Gbokle", "code": "25"},
    {"id": "08", "name": "Gontougo", "code": "08"},
    {"id": "27", "name": "Guémon", "code": "27"},
    {"id": "28", "name": "Hambol", "code": "28"},
    {"id": "02", "name": "Haut-Sassandra", "code": "02"},
    {"id": "29", "name": "Iffou", "code": "29"},
    {"id": "05", "name": "Indénié-Djuablin", "code": "05"},
    {"id": "10", "name": "Kabadougou", "code": "10"},
    {"id": "15", "name": "Lôh-Djiboua", "code": "15"},
    {"id": "12", "name": "Marahoué", "code": "12"},
    {"id": "33", "name": "Mouronou", "code": "33"},
    {"id": "11", "name": "N'Zi", "code": "11"},
    {"id": "03", "name": "Poro", "code": "03"},
    {"id": "32", "name": "Tchologo", "code": "32"},
    {"id": "06", "name": "Tonkpi", "code": "06"},
    {"id": "14", "name": "Worodougou", "code": "14"},
    {"id": "07", "name": "Yamoussoukro", "code": "07"},
  ];
